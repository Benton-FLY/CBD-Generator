...
describe('material normalization and attributes',()=>{
 ...
 it.each([
  ...
  ['HANG TAG FLY RACING 26 F-16 PANT (3 PAGES & 1 EYELET)','HANG TAG FLY RACING 25 F-16 PANT (3 PAGES & 1 EYELET) PFAS FREE (JX)','CONTEXT MATCH'],
